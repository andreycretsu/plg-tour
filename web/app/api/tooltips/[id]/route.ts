  ...
  try {
    ...
    const result = await query(
      `UPDATE tooltips SET
        ...
        title_size = COALESCE($25, title_size),
        body_size = COALESCE($26, body_size),
        body_line_height = COALESCE($27, body_line_height),
        button_text = COALESCE($28, button_text),
        button_color = COALESCE($29, button_color),
